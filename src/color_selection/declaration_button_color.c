...
text_color_selection_t text_color_selection [] = {
    {.pos = {1630, 10}, .path = "Color Selector", .font_path = "game_data/font/JetBrainsMono-Regular.ttf"},
    {.pos = {1680, 460}, .path = "Overview", .font_path = "game_data/font/JetBrainsMono-Regular.ttf"},
    {.pos = {1700, 710}, .path = "Layers", .font_path = "game_data/font/JetBrainsMono-Regular.ttf"}
};

const int size_text_selection_color = sizeof(text_color_selection) / sizeof(text_color_selection_t);
