...
void create_layer_menu_header(int i)
{
    ...
    sfRectangleShape_setOutlineThickness(layer_menu_header[i].rectangle, SIZE_OUTLINE_BUTTON);
    sfRectangleShape_setOutlineColor(layer_menu_header[i].rectangle, sfBlack);
    sfRectangleShape_setSize(layer_menu_header[i].rectangle, layer_menu_header[i].size);
    sfRectangleShape_setFillColor(layer_menu_header[i].rectangle, sfWhite);
    sfRectangleShape_setPosition(layer_menu_header[i].rectangle, layer_menu_header[i].pos);
}
...
{
    text_layer_header[i].font = sfFont_createFromFile(text_layer_header[i].font_path);
...
void create_help_menu_header(int i)
{
    ...
    sfRectangleShape_setOutlineThickness(help_menu_header[i].rectangle, SIZE_OUTLINE_BUTTON);
    sfRectangleShape_setOutlineColor(help_menu_header[i].rectangle, sfBlack);
    sfRectangleShape_setSize(help_menu_header[i].rectangle, help_menu_header[i].size);
    sfRectangleShape_setFillColor(help_menu_header[i].rectangle, sfWhite);
    sfRectangleShape_setPosition(help_menu_header[i].rectangle, help_menu_header[i].pos);
}
...
{
    text_help_header[i].font = sfFont_createFromFile(text_help_header[i].font_path);
