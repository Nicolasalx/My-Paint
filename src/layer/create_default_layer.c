...
void create_default_layer(void)
{
    ...
    sfRectangleShape_setSize(background, (sfVector2f) {SIZE_IMAGE_X, SIZE_IMAGE_Y});
    sfRectangleShape_setFillColor(background, (sfColor) DEFAULT_LAYER_COLOR);

    sfRenderTexture_drawRectangleShape(GET_DATA(head_layer, layer_t)->render_texture, background, NULL);
