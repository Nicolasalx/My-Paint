...
void create_icon_rectangle(int i)
{
    ...
    sfRectangleShape_setOutlineThickness(icon_rectangle[i].rectangle,
        SIZE_OUTLINE_BUTTON);
...
{
    icon_sprite[i].texture =
        sfTexture_createFromFile(icon_sprite[i].path, NULL);
...
void ini_size_pen(void)
{
    ...
    sfRectangleShape_setOutlineThickness(size_pen.rectangle,
        SIZE_OUTLINE_BUTTON);
