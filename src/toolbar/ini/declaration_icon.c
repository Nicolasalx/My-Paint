...
icon_sprite_t icon_sprite [] = {
    ...
    .path = "game_data/toolbar/paint_seal.png"},
    ...
    .path = "game_data/toolbar/circle_draw.png"},

    {.pos = {3, 530}, .size = {0.45, 0.45},
    .path = "game_data/toolbar/rectangle_draw.png"},

    {.pos = {3, 568}, .size = {0.45, 0.45},
